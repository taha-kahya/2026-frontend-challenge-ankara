...
export function NoteCard({ record, onPersonClick }: NoteCardProps) {
  return (
    <div className="group rounded-2xl border border-[--color-border] bg-[--color-surface] p-4 transition-all duration-150 hover:border-emerald-500/30 hover:bg-[--color-surface-raised]">
