...
export function SightingCard({ record, onPersonClick }: SightingCardProps) {
  return (
    <div className="group rounded-2xl border border-amber-500/25 bg-[--color-surface] p-4 transition-all duration-150 hover:border-amber-500/50 hover:bg-[--color-surface-raised] shadow-sm shadow-amber-500/5">
